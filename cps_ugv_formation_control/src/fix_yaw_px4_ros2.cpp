...
private:
    void init(){
        ...
        subscription_pose_ = this->create_subscription<px4_msgs::msg::VehicleOdometry>("/fmu/out/vehicle_odometry", qos, std::bind(&PoseCalibrationNode::px4_callback, this, std::placeholders::_1));
        cali_publisher_ = this->create_publisher<geometry_msgs::msg::PoseStamped>("/calibrated_pose", 1);
