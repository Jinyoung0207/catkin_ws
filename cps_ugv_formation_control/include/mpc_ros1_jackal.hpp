...
class mpc_ros1_jackal : public ros::NodeHandle
{
public:
...
private:
    ...
    gazebo_msgs::ModelStates gazebo_state_msg;

    queue<nav_msgs::Odometry> rbt_odom_queue;
    queue<nav_msgs::Path> rbt_ref_traj_queue;
    queue<gazebo_msgs::ModelStates> gazebo_state_queue;
