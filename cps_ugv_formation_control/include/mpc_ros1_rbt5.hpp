...
class mpc_ros1_rbt5 : public ros::NodeHandle
{
public:
    /*mpc_ros1_rbt5() : NodeHandle("mpc_ros1_rbt5")
    {
...
private:
    ...
    ros::Subscriber rbt4_path_sub;
    nav_msgs::Path rbt4_path_msg;
    queue<nav_msgs::Path> rbt4_path_queue;
    ...
    void rbt4_path_Callback(const nav_msgs::Path::ConstPtr& msg);
    void rbt4_path_update();
    void mpc_init();
};